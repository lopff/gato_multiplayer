...
class PlayGameMultiPage extends StatefulWidget {
  PlayGameMultiPage({Key key}) : super(key: key);

  @override
  _PlayGameMultiPageState createState() => _PlayGameMultiPageState();
}

class _PlayGameMultiPageState extends State<PlayGameMultiPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Gato Multiplayer'), actions: <Widget>[
        FlatButton(
